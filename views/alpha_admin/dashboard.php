            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent20">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class=" nav-item active">
                        <a class=" nav-link text-white" href=" ./dashboard.php " id=" paymentProof2 ">
                ...
                <div class=" col-md-3 side ">
                    <ul>
                        ...
                        <li class=" bg-info p-2">
                            <a href=" ./dashboard.php " id=" paymentProof " class=" text-white ">
                                <i class=" fa fa-money "></i>
            ...
            $.each(data, (i, val) => {
                ...
                let template = `<div class="card mb-2">
                                <div class="card-header ">
                                    ...
                                    <button class="btn btn-sm btn-info offset-md-10 offset-9"><a href="appovePayment.html?proveid=${val.id}" class="text-white">approve</button>
                                </div>
                                <div class="card-body ">
