            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent20">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active ">
                        <a class="nav-link allRegistered2 text-white" href="allRegistered.php" id=" allRegistered2 ">
            ...
            <div class=" row ">
                <div class=" col-md-3 side ">
                    <ul>
                        ...
                        <li class=" bg-info p-2">
                            <a href="allRegistered.html" class="allRegistered  text-white " id=" allRegistered ">
                                <i class=" fa fa-users "></i>
                        ...
                        <li>
                            <a href="allInvestment.html" id=" " class=" text-muted allInvestment ">
                                <i class=" fa fa-bus "></i>
                                <span>All Investments</span>
                            </a>
                        </li>
                ...
                <div class=" col-md-9 pt-5 main ">
                    <div class=" container attach text-muted ">
                        <div class="visitorsholder ">

                            <div class="table-responsive ">
                                <center>
                                    <h4 class="text-muted mb-2 ">
                                        <i class="fa fa-users fa-2x mr-1 text-warning "></i>All Registered Visitor
                                    </h4>
                                </center>
        ...
        $.each(data, (i, val) => {
            template = `
                  <tr>
                    ...
                    <td>${val.Lname}</td>
                    <td>${val.email}</td>
                    <td>${val.date_joined.toLocaleString()}</td>
                  </tr>
                  `
            $(".visitors ").append(template)
        })
    }
